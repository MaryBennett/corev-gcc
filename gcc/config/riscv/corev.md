...
(define_insn "*mov<mode>_hardfloat"
  [(set (match_operand:HFBF 0 "nonimmediate_nonpostic" "=f,   f,f,f,CV_mem_nopm,CV_mem_nopm,*f,*r,  *r,*r,*CV_mem_nopm")
        (match_operand:HFBF 1 "move_operand"         " f,zfli,G,CV_mem_nopm,f,G,*r,*f,*G*r,*CV_mem_nopm,*r"))]
...
(define_insn "*mov<mode>_softfloat"
  [(set (match_operand:HFBF 0 "nonimmediate_nonpostinc" "=f, r,r,CV_mem_nopm,*f,*r")
        (match_operand:HFBF 1 "move_operand"         " f,Gr,CV_mem_nopm,r,*r,*f"))]
